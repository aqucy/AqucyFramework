 ...
 */
public class ${tableConfig.tableName?cap_first}Controller extends Controller {
    @Before(Tx.class)
    public  void index()  throws Exception{
        ${tableConfig.tableName?cap_first}Model model = getModel(${tableConfig.tableName?cap_first}Model.class,"${tableConfig.tableName}");
        ...
        if ("add".equalsIgnoreCase(op)) {
            ...
            render("/WEB-INF/view/project/${tableConfig.tableName}.html");
        }
    }
}
